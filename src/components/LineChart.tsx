...
const LineChart: React.FC<LineChartProps> = ({ covidData }) => {
  ...
  return (
    <div className="relative flex w-full flex-col items-center gap-5 rounded-lg bg-slate-200">
      <h1 className="text-2xl font-semibold mt-5">Covid cases flactuations</h1>
