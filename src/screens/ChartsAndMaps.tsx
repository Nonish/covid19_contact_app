...
const ChartsAndMaps = () => {
  ...
  return (
    <div className="border-box relative my-20 flex w-full flex-1 flex-col items-center gap-20 px-4 md:px-10  bg-white ">
      {/* render worldWide data if the data has been fetched */}
      {worldWideData && (
        <div className="flex w-full flex-col items-center gap-4 rounded-lg py-5">
          <h1 className="text-2xl font-semibold">World Wide Cases</h1>
